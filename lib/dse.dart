                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            child:
                                                              ...
                                                              "Circle",
                                                              _selectedDropdown1, // Changed from _selectedDropdown1!
                                                              _isDropdownLocked(
                                                                  1),
                                                              (value) {
                                                                setState(() {
                                                          ...
                                                          Expanded(
                                                            child:
                                                                _buildFilterDropdown(
                                                              "Region",
                                                              _selectedDropdown2, // Changed from _selectedDropdown2!
                                                              _isDropdownLocked(
                                                                  2),
                                                              (value) {
                                                                setState(() {
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            child:
                                                                _buildFilterDropdown(
                                                              "Area",
                                                              _selectedDropdown3, // Changed from _selectedDropdown3!
                                                              _isDropdownLocked(
                                                                  3),
                                                              (value) {
                                                                setState(() {
                                                          ...
                                                          Expanded(
                                                            child:
                                                                _buildFilterDropdown(
                                                              "Branch",
                                                              _selectedDropdown4, // Changed from _selectedDropdown4!
                                                              _isDropdownLocked(
                                                                  4),
                                                              (value) {
                                                                setState(() {
