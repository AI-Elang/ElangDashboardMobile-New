...
class CheckinOutlet extends StatefulWidget {
  ...
  @override
  State<CheckinOutlet> createState() => _CheckinOutletState();
}

class _CheckinOutletState extends State<CheckinOutlet> {
  ...
  Future<void> _sendCheckinData() async {
    ...
    final uri = Uri.parse('$baseURL/api/v1/outlet/detail/check-in');
    final request = http.MultipartRequest('POST', uri);

    request.headers['Authorization'] = 'Bearer $token';
    request.headers['Accept'] = 'application/json';

    request.fields['outlet_id'] = widget.outletId;
    request.fields['outlet_name'] = widget.outletName;
            ...
            Container(
              ...
              child: Stack(
                ...
                children: [
                  const Center(
                    child: Text(
                      'INPUT CHECK-IN OUTLET', // Changed title
                      style: TextStyle(
                        fontSize: 16,
                        color: Colors.white,
                            ...
                            children: [
                              ...
                              Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      const Text("Outlet Information",
                                          style: TextStyle(
                                              fontSize: 14,
                                              fontWeight: FontWeight.w600,
                                              color: textPrimaryColor)),
                                      const SizedBox(height: 12),
                                      Text("ID: ${widget.outletId}",
                                          style: const TextStyle(
                                              fontSize: 14,
                                              color: textSecondaryColor)),
                                      const SizedBox(height: 6),
                                      Text("Name: ${widget.outletName}",
                                          style: const TextStyle(
                                              fontSize: 14,
                                              color: textSecondaryColor)),
                                    ],
                              ...
                              Center(
                                child: TextButton(
                                  onPressed: () =>
                                      _clearImage(showSnackbar: true),
                                  child: const Text('Clear Image & Notes',
                                      style:
