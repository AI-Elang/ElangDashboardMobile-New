...
class _DseReportState extends State<DseReport> {
  ...
  Widget _buildFilterDropdown(
    ...
    final bool isDisabled = isLocked || _isLoading; // Modify this line
        ...
        children: [
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              // Add disabledHint if you want specific text when disabled
              // disabledHint: Text("Loading...", style: TextStyle(color: Colors.grey.shade400)),
            ),
          ),
        ],
      ),
