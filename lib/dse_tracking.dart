...
class DseTracking extends StatefulWidget {
  const DseTracking({super.key});

  @override
  State<DseTracking> createState() => _DseTrackingState();
}

class _DseTrackingState extends State<DseTracking> {
  ...
  // Helper method to build styled dropdowns (copied from outlet.dart)
  Widget _buildFilterDropdown(
    ...
    final bool isDisabled =
        isLocked || _isLoading; // Consider overall loading state too
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDisabled
            ...
            : Colors.white, // Background for dropdown area
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: isDisabled
                  ...
                  : Colors.grey.shade600, // Lighter color for label
              fontWeight: FontWeight.w500,
            ),
          ),
          ...
          DropdownButtonHideUnderline(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: isDisabled // Disable if loading or locked
                  ? null
  ...
  Widget _buildEmptyState(String title, String subtitle) {
    ...
    return Container(
      ...
      margin: const EdgeInsets.only(bottom: 65), // Match original margin
      decoration: BoxDecoration(
